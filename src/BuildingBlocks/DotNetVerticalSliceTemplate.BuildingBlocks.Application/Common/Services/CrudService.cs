using DotNetVerticalSliceTemplate.BuildingBlocks.CrossCuttingConcerns.Exceptions;
...
using DotNetVerticalSliceTemplate.BuildingBlocks.Domain.Repositories;

namespace DotNetVerticalSliceTemplate.BuildingBlocks.Application.Common.Services;
